...
tinyMCE.init({
    ...
    dialog_type: 'window',
	elements: 'id_summary,id_description,id_details,id_additional_dates_text,id_documentation,id_teaser,id_main_text,id_sidebar_text,id_staff_description,id_extended_description',
    keep_styles: false,
    language: 'en',
