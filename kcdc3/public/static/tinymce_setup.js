...
tinyMCE.init({
    ...
    dialog_type: 'window',
	elements: 'id_summary,id_description,id_details,id_additional_dates_text,id_documentation,id_teaser,id_main_text,id_sidebar_text',
    keep_styles: false,
    language: 'en',
    ...
    theme_advanced_blockformats: 'p,h3,h4,h5,pre',
