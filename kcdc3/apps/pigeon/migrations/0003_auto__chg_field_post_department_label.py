...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.department_label'
        db.alter_column('pigeon_post', 'department_label', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Post.department_label'
        db.alter_column('pigeon_post', 'department_label', self.gf('django.db.models.fields.TextField')())
