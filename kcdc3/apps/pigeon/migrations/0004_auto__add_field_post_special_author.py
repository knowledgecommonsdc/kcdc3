...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.special_author'
        db.add_column(u'pigeon_post', 'special_author',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.special_author'
        db.delete_column(u'pigeon_post', 'special_author')
    ...
    models = {
        ...
        u'pigeon.post': {
            ...
            'author': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'author'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['classes.Bio']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {}),
            'department_label': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_text': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'special_author': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True'}),
