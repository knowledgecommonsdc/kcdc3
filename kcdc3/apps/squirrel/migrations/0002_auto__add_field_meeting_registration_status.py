...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meeting_Registration.status'
        db.add_column(u'squirrel_meeting_registration', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=9),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meeting_Registration.status'
        db.delete_column(u'squirrel_meeting_registration', 'status')
    ...
    models = {
        ...
        u'squirrel.meeting_registration': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '9'}),
