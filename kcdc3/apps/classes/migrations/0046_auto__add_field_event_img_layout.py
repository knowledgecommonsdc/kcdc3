...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.img_layout'
        db.add_column(u'classes_event', 'img_layout',
                      self.gf('django.db.models.fields.CharField')(default='large', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.img_layout'
        db.delete_column(u'classes_event', 'img_layout')
