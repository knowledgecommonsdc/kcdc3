...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.teacher_text'
        db.add_column('classes_event', 'teacher_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.teacher_text'
        db.delete_column('classes_event', 'teacher_text')
    ...
    models = {
        ...
        'classes.event': {
            ...
            'teacher_text': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
