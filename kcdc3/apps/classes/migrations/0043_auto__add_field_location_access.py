...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.access'
        db.add_column(u'classes_location', 'access',
                      self.gf('django.db.models.fields.CharField')(default='SEMIPUBLIC', max_length=11),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.access'
        db.delete_column(u'classes_location', 'access')
