...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Session.show_sidebar_text'
        db.add_column('classes_session', 'show_sidebar_text',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Session.show_sidebar_text'
        db.delete_column('classes_session', 'show_sidebar_text')
