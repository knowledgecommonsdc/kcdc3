...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partner.featured'
        db.add_column(u'classes_partner', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partner.featured'
        db.delete_column(u'classes_partner', 'featured')
    ...
    models = {
        ...
        u'classes.bio': {
            ...
            'staff_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'classes.event': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'img_layout': ('django.db.models.fields.CharField', [], {'default': "'large'", 'max_length': '5'}),
            'list_layout': ('django.db.models.fields.CharField', [], {'default': "'large'", 'max_length': '5'}),
