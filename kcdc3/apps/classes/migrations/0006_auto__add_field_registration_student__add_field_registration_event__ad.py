...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Registration.event'
        db.add_column('classes_registration', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['classes.Event'], null=True),
                      keep_default=False)

        # Adding field 'Registration.waitlist'
        db.add_column('classes_registration', 'waitlist',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Registration.attended'
        db.add_column('classes_registration', 'attended',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Registration.student'
        db.delete_column('classes_registration', 'student_id')

        # Deleting field 'Registration.event'
        db.delete_column('classes_registration', 'event_id')

        # Deleting field 'Registration.waitlist'
        db.delete_column('classes_registration', 'waitlist')

        # Deleting field 'Registration.attended'
        db.delete_column('classes_registration', 'attended')
