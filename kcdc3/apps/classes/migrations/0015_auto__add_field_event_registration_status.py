...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.registration_status'
        db.add_column('classes_event', 'registration_status',
                      self.gf('django.db.models.fields.CharField')(default='AUTO', max_length=7),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.registration_status'
        db.delete_column('classes_event', 'registration_status')
