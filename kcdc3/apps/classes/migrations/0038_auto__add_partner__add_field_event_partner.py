...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'classes_partner', (
        ...
        db.send_create_signal(u'classes', ['Partner'])

        # Adding field 'Event.partner'
        db.add_column(u'classes_event', 'partner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='partner', null=True, on_delete=models.SET_NULL, to=orm['classes.Partner']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Partner'
        db.delete_table(u'classes_partner')

        # Deleting field 'Event.partner'
        db.delete_column(u'classes_event', 'partner_id')
