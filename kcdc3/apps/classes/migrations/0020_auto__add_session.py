...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('classes_session', (
            ...
            ('registration_status', self.gf('django.db.models.fields.CharField')(default='PREVENT', max_length=7)),
        ))
        db.send_create_signal('classes', ['Session'])

        # Adding M2M table for field session on 'Event'
        db.create_table('classes_event_session', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['classes.event'], null=False)),
            ('session', models.ForeignKey(orm['classes.session'], null=False))
        ))
        db.create_unique('classes_event_session', ['event_id', 'session_id'])


    def backwards(self, orm):
        # Deleting model 'Session'
        db.delete_table('classes_session')

        # Removing M2M table for field session on 'Event'
        db.delete_table('classes_event_session')
    ...
    models = {
        ...
        'classes.event': {
            ...
            'session': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'session'", 'symmetrical': 'False', 'to': "orm['classes.Session']"}),
