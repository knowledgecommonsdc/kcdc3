...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Bio', fields ['name']
        db.create_unique('classes_bio', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Bio', fields ['name']
        db.delete_unique('classes_bio', ['name'])
