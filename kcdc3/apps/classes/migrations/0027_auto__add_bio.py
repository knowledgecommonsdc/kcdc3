...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bio'
        db.create_table('classes_bio', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
        ))
        db.send_create_signal('classes', ['Bio'])

        # Adding M2M table for field teacher_bios on 'Event'
        db.create_table('classes_event_teacher_bios', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['classes.event'], null=False)),
            ('bio', models.ForeignKey(orm['classes.bio'], null=False))
        ))
        db.create_unique('classes_event_teacher_bios', ['event_id', 'bio_id'])


    def backwards(self, orm):
        # Deleting model 'Bio'
        db.delete_table('classes_bio')

        # Removing M2M table for field teacher_bios on 'Event'
        db.delete_table('classes_event_teacher_bios')
    ...
    models = {
        ...
        'classes.event': {
            ...
            'teacher_bios': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'teacher_bios'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['classes.Bio']"}),
