...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.teachers'
        db.delete_column('classes_event', 'teachers_id')

        # Adding M2M table for field teachers on 'Event'
        db.create_table('classes_event_teachers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['classes.event'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('classes_event_teachers', ['event_id', 'user_id'])


    def backwards(self, orm):
        # Adding field 'Event.teachers'
        db.add_column('classes_event', 'teachers',
        ...
        db.delete_table('classes_event_teachers')
    ...
    models = {
        ...
        'classes.event': {
            ...
            'teachers': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
