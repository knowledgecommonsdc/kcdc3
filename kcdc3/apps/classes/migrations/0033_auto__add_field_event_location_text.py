...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.location_text'
        db.add_column('classes_event', 'location_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.location_text'
        db.delete_column('classes_event', 'location_text')
