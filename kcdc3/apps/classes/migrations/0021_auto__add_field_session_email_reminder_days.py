...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.email_reminder_days'
        db.add_column('classes_session', 'email_reminder_days',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.email_reminder_days'
        db.delete_column('classes_session', 'email_reminder_days')
    ...
    models = {
        ...
        'classes.event': {
            ...
            'session': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'session'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['classes.Session']"}),
