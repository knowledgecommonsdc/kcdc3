...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.department_label'
        db.add_column('pigeon_post', 'department_label',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.department_label'
        db.delete_column('pigeon_post', 'department_label')
    ...
    models = {
        ...
        'pigeon.post': {
            ...
            'department_label': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
