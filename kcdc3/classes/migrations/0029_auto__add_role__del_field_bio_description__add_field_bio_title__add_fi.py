...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('classes', ['Role'])

        # Deleting field 'Bio.description'
        db.delete_column('classes_bio', 'description')

        # Adding field 'Bio.title'
        db.add_column('classes_bio', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Bio.staff_description'
        db.add_column('classes_bio', 'staff_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Bio.role'
        db.add_column('classes_bio', 'role',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='role', null=True, on_delete=models.SET_NULL, to=orm['classes.Role']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Role'
        db.delete_table('classes_role')

        # Adding field 'Bio.description'
        db.add_column('classes_bio', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Bio.title'
        db.delete_column('classes_bio', 'title')

        # Deleting field 'Bio.staff_description'
        db.delete_column('classes_bio', 'staff_description')

        # Deleting field 'Bio.role'
        db.delete_column('classes_bio', 'role_id')
    ...
    models = {
        ...
        'classes.event': {
            ...
            'session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'session'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['classes.Session']"}),
            ...
            'teacher_bios': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'event'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['classes.Bio']"}),
