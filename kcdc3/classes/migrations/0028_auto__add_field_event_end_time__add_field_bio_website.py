...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('classes_event', 'end_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bio.website'
        db.add_column('classes_bio', 'website',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('classes_event', 'end_time')

        # Deleting field 'Bio.website'
        db.delete_column('classes_bio', 'website')
