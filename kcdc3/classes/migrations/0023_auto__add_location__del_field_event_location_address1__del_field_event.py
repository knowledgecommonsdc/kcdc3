...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('classes_location', (
            ...
            ('city', self.gf('django.db.models.fields.CharField')(default='Washington', max_length=60, blank=True)),
            ('state', self.gf('django.db.models.fields.CharField')(default='DC', max_length=2, blank=True)),
            ('zip', self.gf('django.db.models.fields.CharField')(max_length=5, blank=True)),
            ('show_exact', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        ...
        db.add_column('classes_event', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='location', null=True, on_delete=models.SET_NULL, to=orm['classes.Location']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('classes_event', 'location_city',
                      self.gf('django.db.models.fields.CharField')(default='Washington', max_length=60, blank=True),
                      keep_default=False)

        # Adding field 'Event.location_state'
        db.add_column('classes_event', 'location_state',
                      self.gf('django.db.models.fields.CharField')(default='DC', max_length=2, blank=True),
                      keep_default=False)
        ...
        db.delete_column('classes_event', 'location_id')
