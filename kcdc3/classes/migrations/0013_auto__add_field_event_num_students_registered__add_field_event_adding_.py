...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.num_students_registered'
        db.add_column('classes_event', 'num_students_registered',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Event.adding_to_waitlist'
        db.add_column('classes_event', 'adding_to_waitlist',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.num_students_registered'
        db.delete_column('classes_event', 'num_students_registered')

        # Deleting field 'Event.adding_to_waitlist'
        db.delete_column('classes_event', 'adding_to_waitlist')
    ...
    models = {
        ...
        'classes.event': {
            ...
            'adding_to_waitlist': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'num_students_registered': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
