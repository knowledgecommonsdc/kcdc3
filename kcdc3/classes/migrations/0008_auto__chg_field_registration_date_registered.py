...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Registration.date_registered'
        db.alter_column('classes_registration', 'date_registered', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Registration.date_registered'
        db.alter_column('classes_registration', 'date_registered', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
