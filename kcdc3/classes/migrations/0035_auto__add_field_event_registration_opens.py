...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.registration_opens'
        db.add_column('classes_event', 'registration_opens',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.registration_opens'
        db.delete_column('classes_event', 'registration_opens')
