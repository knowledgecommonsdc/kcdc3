...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.session'
        db.add_column('classes_event', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='session', null=True, on_delete=models.SET_NULL, to=orm['classes.Session']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Event.session'
        db.delete_column('classes_event', 'session_id')
