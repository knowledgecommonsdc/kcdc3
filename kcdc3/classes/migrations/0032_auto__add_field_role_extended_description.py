...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Role.extended_description'
        db.add_column('classes_role', 'extended_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Role.extended_description'
        db.delete_column('classes_role', 'extended_description')
